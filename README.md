...
A number indicating the priority of the work represented by the fiber. The [Scheduler](https://github.com/facebook/react/blob/main/packages/scheduler/src/forks/Scheduler.js) module lists the different priority levels and what they represent.
